...
export const metadata: Metadata = {  // Metadados básicos
  ...
  description: "Psicólogo humanista online com atendimento para ansiedade, depressão, autoconhecimento e regulação emocional. Abordagem Centrada na Pessoa (ACP) e Focalização para adultos e adolescentes em qualquer local do Brasil e do mundo, em língua portuguesa. Também trabalho com psicologia racial, oferecendo ambiente acolhedor e culturalmente sensível para questões étnico-raciais e comunidade LGBTQIA+.",
  ...
  openGraph: {
    ...
    title: "Psicólogo Daniel Dantas | Terapia Online Humanista | CRP 11/11854",
    description: "Atendimento psicológico online humanizado e acolhedor para ansiedade, depressão, estresse e autoconhecimento. Também trabalho com psicologia racial e espaço seguro para comunidade LGBTQIA+. Atendimento em português para pessoas no Brasil e no exterior, com disponibilidade flexível.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Psicólogo Daniel Dantas | Terapia Online Humanista | CRP 11/11854",
    description: "Atendimento psicológico para ansiedade, depressão e traumas. Psicoterapia online humanizada para brasileiros no Brasil e exterior, também trabalho com psicologia racial, ambiente acolhedor para comunidade LGBTQIA+, horários flexíveis.",
