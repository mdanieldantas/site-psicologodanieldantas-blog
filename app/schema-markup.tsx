// Schemas estáticos para evitar problemas de hidratação
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description: "Atendimento individual focado em autoconhecimento, superação de desafios emocionais e promoção da saúde mental.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description: "Oficinas e grupos terapêuticos para práticas de regulação emocional e autoconhecimento.",
        },
      },
    ],
  },
...
const faqPageSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Minha abordagem é baseada na Abordagem Centrada na Pessoa (ACP), que valoriza a empatia, a escuta ativa e o respeito pela singularidade de cada indivíduo. Também utilizo técnicas de Focalização para ajudar no processo de autoconhecimento e regulação emocional, além de técnicas de Mindfulness.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Você pode agendar uma consulta através do formulário de contato neste site, ou entrar em contato diretamente pelo WhatsApp. Após o contato inicial, agendaremos um horário que seja conveniente para você.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Sim, ofereço um espaço seguro para pessoas LGBTQIA+ respeitando a diversidade de identidades de gênero e orientações sexuais.",
      },
    },
  ],
  contactPoint: [
