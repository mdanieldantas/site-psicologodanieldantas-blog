...
export default function ExploreCategoriesGrid({ categories }: ExploreCategoriesGridProps) {
  ...
  return (
    <section className="relative py-16 md:py-20 bg-gradient-to-br from-[#F8F5F0] via-[#F4EED9] to-[#F8F5F0] overflow-hidden">
      {/* Padrão decorativo de fundo animado */}
      <MotionDiv 
      ...
      >
        <MotionDiv 
          className="absolute top-0 left-0 w-96 h-96 bg-[#C19A6B] rounded-full blur-3xl transform -translate-x-1/2 -translate-y-1/2"
          animate={{ 
            scale: [1, 1.1, 1],
            rotate: [0, 90, 0],
          }}
        ...
        />
        <MotionDiv 
          className="absolute bottom-0 right-0 w-80 h-80 bg-[#735B43] rounded-full blur-3xl transform translate-x-1/2 translate-y-1/2"
          animate={{ 
            scale: [1.1, 1, 1.1],
            rotate: [0, -90, 0],
          }}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <MotionDiv 
            className="inline-flex items-center justify-center w-16 h-16 bg-[#C19A6B]/10 rounded-full mb-6"
          ...
          <MotionP 
            className="text-xl text-[#735B43] max-w-3xl mx-auto leading-relaxed"
            variants={cardVariants}
          >
        ...
        {categories.length > 0 ? (
          ...
          >
            <MotionDiv 
              className="inline-flex items-center justify-center w-20 h-20 bg-[#C19A6B]/10 rounded-full mb-8"
              whileHover={{ scale: 1.05 }}
              transition={{ type: "spring", stiffness: 300 }}
            >
              <MotionSVG 
                className="w-10 h-10 text-[#735B43]" 
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
                initial={{ rotate: 0 }}
            ...
            <MotionP 
              className="text-[#735B43] max-w-md mx-auto"
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
