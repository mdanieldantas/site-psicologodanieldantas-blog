...
const AboutTeaserBanner = () => {
  return (    <section className="py-16 bg-gradient-to-br from-[#F8F5F0] to-[#F8F5F0]/80">      <div className="container mx-auto px-2 sm:px-4 max-w-[1440px]">
        {/* Container principal */}
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 md:p-12 lg:p-16 xl:p-20 shadow-xl border border-[#A57C3A]/10 w-full mx-auto relative">
          ...
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#A57C3A] to-transparent"></div>            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-6">            {/* Coluna de imagem */}
            <div className="w-full md:w-1/2 lg:w-1/2">              <div className="bg-[#F8F5F0] p-4 md:p-6 lg:p-8 xl:p-10 rounded-xl shadow-xl mx-auto flex items-center justify-center">
                {/* Imagem do Autor */}
                <img 
            ...
            {/* Coluna de texto */}
            <div className="w-full md:w-1/2 lg:w-1/2 text-left">              <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-[#583B1F] font-normal mb-4 lg:mb-6 font-['Old Roman'] relative inline-block">
                Nossa História
              ...
              <Link
                ...
                className="inline-flex items-center px-7 py-4 lg:px-8 lg:py-5 bg-[#583B1F] text-white text-lg lg:text-xl rounded-md hover:bg-[#735B43] transition-all duration-300 transform hover:scale-105 shadow-lg group"
              >
