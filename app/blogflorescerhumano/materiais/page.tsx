...
import { ChevronRight, BookOpen, FileText, Video, Headphones } from 'lucide-react';
    ...
    <div className="bg-[#F8F5F0] min-h-screen">
      ...
      <section className="relative h-[60vh] md:h-[70vh] overflow-hidden">
        <BannerImage
          ...
          alt="Banner da página de materiais"
          className="brightness-75"
        />
        
        {/* Overlay com gradiente */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#583B1F]/80 via-[#583B1F]/60 to-transparent"></div>
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8 font-sans leading-relaxed">
      ...
      {/* Breadcrumb */}
      <nav className="bg-[#F8F5F0]/80 backdrop-blur-sm border-b border-[#E8E6E2] py-4">
        <div className="container mx-auto px-4">
          <ol className="flex items-center space-x-2 text-sm font-sans">
            <li>
              <a href="/" className="text-[#7D6E63] hover:text-[#583B1F] transition-colors duration-200">
                Início
              </a>
            </li>
            <ChevronRight className="h-4 w-4 text-[#A57C3A]" />
            <li>
              <a href="/blogflorescerhumano" className="text-[#7D6E63] hover:text-[#583B1F] transition-colors duration-200">
                Blog
              </a>
            </li>
            <ChevronRight className="h-4 w-4 text-[#A57C3A]" />
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* E-books */}
            <div className="bg-white rounded-lg p-6 shadow-md border border-[#E8E6E2] hover:shadow-lg transition-shadow duration-200">
