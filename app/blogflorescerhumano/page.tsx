      ...
      <section className="relative min-h-screen md:h-[90vh] py-16 bg-gradient-to-br from-[#583B1F]/10 to-[#F8F5F0]/90" id="hero-section">
        ...
        <div className="container mx-auto px-4 h-full flex flex-col-reverse md:flex-row items-center justify-between relative z-10">
          {/* Coluna de texto - à esquerda em desktop */}          <div className="w-full md:w-1/2 text-left md:pr-8 mb-10 md:mb-0 mt-0 sm:mt-6 md:mt-0 animate-[fadeIn_1s_ease_forwards] hero-container">
            ...
            <h2 className="text-lg md:text-xl text-[#583B1F] font-light mb-8 animate-[slideUp_1s_ease_forwards] delay-100 tracking-wider hero-subtitle">
              por <span className="font-semibold text-[#583B1F] high-contrast-text">Psicólogo Daniel Dantas</span>
            </h2>
            
            <p className="text-xl md:text-2xl text-[#583B1F] font-normal leading-relaxed max-w-xl animate-[slideUp_1s_ease_forwards] delay-200 mb-12 hero-description">
            ...
            >
              ...
              {/* Assinatura visual */}              <div className="mt-10 flex items-center animate-[fadeIn_1s_ease_forwards] delay-500">
            ...
            <div className="relative group animate-[fadeIn_1s_ease_forwards] delay-300 content-visibility-auto">
              ...
              <div className="relative z-10 transform transition-all duration-500 md:hover:scale-[1.02]">
                ...
                <div className="relative overflow-hidden shadow-xl z-10 rounded-[35%_65%_65%_35%/25%_30%_70%_75%] border-2 border-[#C19A6B]/20">
                  <div className="w-[280px] h-[320px] md:w-[400px] md:h-[450px] relative">                    <Image
                ...
                {/* Folha superior esquerda */}                <div className="absolute -top-6 -left-6 z-20 animate-[sway_4s_ease-in-out_infinite_alternate] hidden sm:block">
                ...
                <div className="absolute -bottom-8 -right-4 z-20 rotate-45 animate-[sway_5s_ease-in-out_infinite_alternate] hidden sm:block" style={{ animationDelay: "-2s" }}>
                ...
                <div className="absolute -bottom-2 -left-8 z-20 animate-pulse hidden sm:block" style={{ animationDuration: "6s" }}>
                ...
                <div className="absolute -top-4 right-6 z-20 animate-pulse hidden sm:block" style={{ animationDuration: "7s" }}>
        ...
        </div>{" "}        {/* Elementos florais decorativos sutis representando crescimento - apenas visíveis em telas maiores */}
        <div className="absolute bottom-24 left-10 md:left-20 opacity-20 animate-pulse hidden md:block" style={{ animationDuration: "5s" }}>
          <svg
            viewBox="0 0 200 200"
            width="80"
            height="80"
        ...
        </div>{/* Seta indicativa de scroll com animação melhorada */}        <div className="absolute bottom-8 left-0 right-0 z-10 flex justify-center animate-[fadeIn_1s_ease_forwards] delay-600 will-change-transform">
          <button 
