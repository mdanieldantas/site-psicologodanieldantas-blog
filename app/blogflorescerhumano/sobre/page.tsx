  ...
  return (
    <div className="min-h-screen bg-[#F8F5F0]">
      ...
      <main className="container mx-auto px-4 pb-12 pt-8">
        ...
        <section className="mb-16 bg-white p-8 rounded-xl shadow-lg border border-[#A57C3A]/20">
      ...
      <section className="mb-16 bg-white p-8 rounded-xl shadow-lg border border-[#A57C3A]/20 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500">
      ...
      {/* Seção: Sobre o Autor */}
      {autor && (
        <section className="mb-16 bg-white p-8 rounded-xl shadow-lg border border-[#A57C3A]/20 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-600">
